...
Для тестирования модулей ядра стандартный Docker-контейнер не подходит — ему нужны привилегии хоста. На вм, где установлен GitLab Runner, откройте `/etc/gitlab-runner/config.toml` и в секции `[runners.docker]` установите параметр `privileged` в значении `true`
